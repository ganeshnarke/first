...
class Userfmodel extends CI_Model
{

	 // add user
 public function add_usermodel($data,$to)
  {
                                 ...
                                 <td>
                                    <!--<table class="container" align="center" width="380" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; border: 0px; ">
                                       <tbody>
										  ...
										  <table class="title" border="0" cellspacing="0" cellpadding="0" align="center" style="border: 0px; cellpadding:0px; cellspacing:0px; border-collapse:collapse; border: 0px;">
                                       <tbody>
                                          <tr>
                                             <td>
                                                <table border="0" cellspacing="0" cellpadding="0" align="center" style="border: 0px; cellpadding:0px; cellspacing:0px; border-collapse:collapse; border: 0px;">
                                                   <tbody>
                                                      <tr>
													  
                                                         <br><!--<td bgcolor="#E65c00;" width="140" height="40" style="background:#E65c00;font-family:"Raleway", Open Sans, sans-serif; font-size:16px; font-weight:500; text-align:center; color:#000000; border-radius:5px;" data-bgcolor="s1_button_bg">
                                                            <a href="#" style="text-decoration:none; color:#fff;" data-size="s1_btn1_text_size" data-min="12" data-max="36" data-color="s1_btn1_text_color" mc:edit="s1_b1">
                                                               Reset Password
                                                            </a>
                                                         </td>-->
                                                         <!-- margin -->
...
<!-- section_15 -->
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#E65c00;" data-bgcolor="s20_bg_main" style="table-layout:fixed;margin:0 auto; border-collapse:collapse; border: 0px; max-width:800px;border-top:2px solid #E65c00;background:#E65c00;" data-module="section_15" data-thumb="thumbnails/s15.png">
    <tbody>
      <tr mc:repeatable="">
                           ...
                           <tbody>
                              <tr>
                                 <td align="right" class="title" >
                                    <a href="#" style="text-decoration:none;font-family: "Raleway", sans-serif; font-weight:400; font-size: 14px; line-height:24px; text-align:right; color:#fff;" data-size="s15_unsubscribe_size" data-min="12" data-max="36" data-color="s15_unsubscribe_color" mc:edit="s15_unsubscribe">2017 Banca | All Rights Reserved</a> 
                                 </td>
                              </tr>
                              <!-- margin -->
                              <tr>
...
<!-- section_15 -->
 ...
 $headers='From: superganesh1990@gmail.com' . "\r\n" .
    'Reply-To: superganesh1990@gmail.com' . "\r\n" .
  ...
  public function registerlistmodel()
 {
     $q=$this->db->get('users');
